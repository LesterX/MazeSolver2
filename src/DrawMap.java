...
public class DrawMap extends JFrame {
  ...
  /* ============================= */
    ...
    try {
      ...
      display.drawString("Toll = "+tollCost+", Compensation = "+compGain,3,(2*mapLength-1)*gridSize+11);
      display.setColor(backColor);
 ...
 /* ================================================================= */
  ...
  /* ================================================================= */
     ...
     for (row = 0; row < (2*mapLength-1); ++row)
           ...
           /* Draw a row of the map */
	         switch (lab[row][i]) {
		 case 'T': if ((row % 2) == 0) drawHorPay(i,row,false,tollColor,toll);
		 ...
		 case 'C': if ((row % 2) == 0) drawHorPay(i,row,false,compColor,comp);
                   ...
                   break;			   
          case 'X': drawBlock(i,row); break;
		  case 'F': if ((row % 2) == 0) drawHorRoad(i,row,streetColor);
  ...
  /* Draw a vertical toll or compensation road */
  /* ================================================================= */
  ...
  /* Draw a horizontal toll or compensation road */
  /* ================================================================= */
  ...
  /* Draw a vertical toll or compensation booth */
  /* ================================================================= */
  ...
  /* Draw a horizontal toll or compensation booth */
  /* ================================================================= */
  ...
  /* Draw a vertical open toll or compensation booth */
  /* ================================================================= */
  ...
  /* Draw a horizontal open toll or compensation booth */
  /* ================================================================= */
